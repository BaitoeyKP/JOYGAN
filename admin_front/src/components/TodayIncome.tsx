  ...
  return (
    <div className="flex flex-col items-center space-y-14">
      ...
      <div className="flex flex-col items-center">
        <h2 className="text-5xl flex items-center">{total.toLocaleString()} บาท</h2>
        <h3 className={`${morethan > 0 && morethanper > 0 ? "text-green-ok" : "text-red-cancel"}  text-lg lg:text-3xl `}>
