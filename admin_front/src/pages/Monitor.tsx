...
function Monitor() {
    ...
    return (
        ...
        <div className="bg-cream-bg min-h-screen h-full w-screen">
            {/* <div className=" grid grid-cols-2 h-screen w-full items-center ">
                ...
                <div>
                    <div className="flex basis-1/2 justify-center items-center flex-col">
                        <h1 className="text-5xl font-bold font-black-text mb-4 text-black-text">ยอดสนับสนุนสูงสุด</h1>
                        <div className="w-[500px] pb-5 pt-5">{topSpender}</div>
                    </div>
                    <div className="flex basis-1/2 justify-center items-center flex-col">
                        <img src={qrCode} alt="" className="w-[200px] mb-6 rounded-xl" />
                        <p className="text-5xl font-bold font-black-text text-black-text">ดาวน์โหลดแอปพลิเคชั่น</p>
                    </div>
                </div>
            </div> */}
            ...
            <div className="flex flex-col h-screen w-screen justify-center items-center">
                <div className="grid grid-cols-2 w-full items-end pt-5 ">
                    ...
                    <div>
                        <h1 className="text-5xl font-bold font-black-text text-center  text-black-text">ยอดสนับสนุนสูงสุด</h1>
                    </div>
                </div>
                <div className="grid grid-cols-2 w-full items-end pt-5 ">
                    <div className="flex basis-1/2 justify-center items-center flex-col">
                    ...
                    <div className="flex  items-center flex-col">
                        <div className="w-[500px] pb-20 pt-5">{topSpender}</div>
                        <img src={qrCode} alt="" className="w-[200px] mb-10 rounded-xl" />
                        <p className="text-5xl font-bold font-black-text text-black-text">ดาวน์โหลดแอปพลิเคชั่น</p>
                    </div>
                </div>
            </div>
